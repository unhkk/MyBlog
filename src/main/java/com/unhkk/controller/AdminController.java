...
public class AdminController extends BaseController {
	...
	public String adminEdit(Model model) {
		...
		model.addAttribute("tags", StringUtil.listToString(tags1));
	...
	public String adminModify(Model model,@RequestParam(defaultValue = "0") int cid) {
		...
		String tags = "";
		List<String> strings = StringUtil.stringToList(content.getTagList());
	...
	public String adminEditBlog(Model model) {
		...
		for (String s:blogTag) {
			...
			content.setTagList(StringUtil.listToString(tagListNew));
		}

package com.unhkk.controller;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.github.pagehelper.PageHelper;
import com.unhkk.entity.Content;
import com.unhkk.entity.Tag;
import com.unhkk.utils.DateTimeUtil;
import com.unhkk.utils.LogUtil;
import com.unhkk.utils.StringUtil;
...
public class OtherController extends BaseController {
	...
	public String index(@RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum,
		...
		for (Content c : contents) {
			...
			List<String> strings = StringUtil.stringToList(c.getTagList());
	...
	public Map<String,Object> getTodayYesterdayAccess() {
		...
		dataMap.put(DateTimeUtil.todayDateConvertString(),mapToday);
	...
	public Map<String,Object> getLastWeekendAccess() {
		...
		for (int i = 7; i > 0; i--) {
			...
			mapLastWeek.put("date", DateTimeUtil.calculateApartDayConvertString(i));
